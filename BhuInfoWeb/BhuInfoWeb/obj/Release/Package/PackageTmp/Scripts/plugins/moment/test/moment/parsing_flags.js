...
test("extra tokens strict",
    function(assert) {
        ...
        assert.deepEqual(flags("1982", "YYYY-MM-DD", true).unusedTokens,
            ["-", "MM", "-", "DD"],
        ...
        assert.deepEqual(flags("1982 05 1982", "YYYY-MM-DD", true).unusedTokens,
            ["-", "-"],
...
test("unused input",
    function(assert) {
        ...
        assert.deepEqual(flags("1982-05-25 this is more stuff", "YYYY-MM-DD").unusedInput,
            [" this is more stuff"],
            "trailing nonsense");
        assert.deepEqual(flags("1982-05-25 09:30", "YYYY-MM-DD").unusedInput,
            [" 09:30"],
            ["trailing legit-looking input"]);
        assert.deepEqual(flags("1982-05-25 some junk", "YYYY-MM-DD [some junk]").unusedInput,
            [],
            "junk that actually gets matched");
        assert.deepEqual(flags("stuff at beginning 1982-05-25", "YYYY-MM-DD").unusedInput,
            ["stuff at beginning "],
            "leading junk");
        assert.deepEqual(flags("junk 1982 more junk 05 yet more junk25", "YYYY-MM-DD").unusedInput,
...
test("unused input strict",
    function(assert) {
        ...
        assert.deepEqual(flags("1982-05-25 this is more stuff", "YYYY-MM-DD", true).unusedInput,
            [" this is more stuff"],
            "trailing nonsense");
        assert.deepEqual(flags("1982-05-25 09:30", "YYYY-MM-DD", true).unusedInput,
            [" 09:30"],
            ["trailing legit-looking input"]);
        assert.deepEqual(flags("1982-05-25 some junk", "YYYY-MM-DD [some junk]", true).unusedInput,
            [],
            "junk that actually gets matched");
        assert.deepEqual(flags("stuff at beginning 1982-05-25", "YYYY-MM-DD", true).unusedInput,
            ["stuff at beginning "],
            "leading junk");
        assert.deepEqual(flags("junk 1982 more junk 05 yet more junk25", "YYYY-MM-DD", true).unusedInput,
            ["junk ", " more junk ", " yet more junk"],
            "interstitial junk");
    });
...
test("chars left over",
    function(assert) {
        ...
        assert.equal(flags("1982-05-25 this is more stuff", "YYYY-MM-DD").charsLeftOver,
            " this is more stuff".length,
            "trailing nonsense");
        assert.equal(flags("1982-05-25 09:30", "YYYY-MM-DD").charsLeftOver,
            " 09:30".length,
            "trailing legit-looking input");
        assert.equal(flags("stuff at beginning 1982-05-25", "YYYY-MM-DD").charsLeftOver,
            "stuff at beginning ".length,
            "leading junk");
        assert.equal(flags("1982 junk 05 more junk25", "YYYY-MM-DD").charsLeftOver,
            [" junk ", " more junk"].join("").length,
            "interstitial junk");
        assert.equal(flags("stuff at beginning 1982 junk 05 more junk25", "YYYY-MM-DD").charsLeftOver,
