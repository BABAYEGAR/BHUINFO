...
test("is same or before year",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 11, 31, 23, 59, 59, 999)), "year"),
            true,
            "exact end of year");
        assert.equal(m.isSameOrBefore(moment(new Date(2012, 0, 1, 0, 0, 0, 0)), "year"), true, "start of next year");
        assert.equal(m.isSameOrBefore(moment(new Date(2010, 11, 31, 23, 59, 59, 999)), "year"),
            false,
...
test("is same or before month",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 2, 31, 23, 59, 59, 999)), "month"),
            true,
            "exact end of month");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 1, 0, 0, 0, 0)), "month"), true, "start of next month");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 27, 23, 59, 59, 999)), "month"),
            false,
...
test("is same or before day",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 1, 23, 59, 59, 999)), "day"),
            false,
            "end of previous day");
...
test("is same or before hour",
    function(assert) {
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 2, 59, 59, 999)), "hour"),
            false,
...
test("is same or before minute",
    function(assert) {
        ...
        assert.equal(m
            .isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 9, 10)), "minutes"),
            true,
            "plural should work");
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 0, 0)), "minute"),
            true,
            "exact start of minute");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 59, 999)), "minute"),
            true,
            "exact end of minute");
        assert.equal(m
            .isSameOrBefore(moment(new Date(2011, 1, 2, 3, 5, 0, 0)), "minute"),
            true,
            "start of next minute");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 3, 59, 999)), "minute"),
            false,
...
test("is same or before second",
    function(assert) {
        ...
        assert.equal(m
            .isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 5, 10)), "seconds"),
            true,
            "plural should work");
        ...
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 5, 0)), "second"),
            true,
            "exact start of second");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 5, 999)), "second"),
            true,
            "exact end of second");
        assert.equal(m
            .isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 6, 0)), "second"),
            true,
            "start of next second");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 1, 2, 3, 4, 4, 999)), "second"),
            false,
...
test("is same or before millisecond",
    function(assert) {
        var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), "millisecond"),
            true,
            "millisecond match");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), "milliseconds"),
            true,
            "plural should work");
        assert.equal(m.isSameOrBefore(moment(new Date(2012, 3, 2, 3, 4, 5, 10)), "millisecond"), true, "year is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), "millisecond"),
            false,
            "year is earlier");
        assert.equal(m
            .isSameOrBefore(moment(new Date(2011, 4, 2, 3, 4, 5, 10)), "millisecond"),
            true,
            "month is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 2, 2, 3, 4, 5, 10)), "millisecond"),
            false,
            "month is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 3, 3, 4, 5, 10)), "millisecond"), true, "day is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 1, 1, 4, 5, 10)), "millisecond"),
            false,
            "day is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 4, 4, 5, 10)), "millisecond"), true, "hour is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 1, 4, 1, 5, 10)), "millisecond"),
            false,
            "hour is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 5, 5, 10)), "millisecond"),
            true,
            "minute is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 3, 5, 10)), "millisecond"),
            false,
            "minute is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 6, 10)), "millisecond"),
            true,
            "second is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 4, 5)), "millisecond"),
            false,
            "second is earlier");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 6, 11)), "millisecond"),
            true,
            "millisecond is later");
        assert.equal(m.isSameOrBefore(moment(new Date(2011, 3, 2, 3, 4, 4, 9)), "millisecond"),
            false,
...
test("is same with utc offset moments",
    function(assert) {
        assert.ok(moment.parseZone("2013-02-01T-05:00").isSameOrBefore(moment("2013-02-01"), "year"),
            "zoned vs local moment");
        assert.ok(moment("2013-02-01").isSameOrBefore(moment("2013-02-01").utcOffset("-05:00"), "year"),
