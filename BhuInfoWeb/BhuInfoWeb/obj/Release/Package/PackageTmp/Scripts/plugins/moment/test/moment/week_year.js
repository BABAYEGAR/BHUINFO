...
test("weeks overflow",
    function(assert) {
        ...
        assert
            .equal(7, moment.utc("2004-W00-1", moment.ISO_8601, true).parsingFlags().overflow, "there is no 0th week");
    });
...
test("week year setter works",
    function(assert) {
        for (var year = 2000; year <= 2020; year += 1) {
            assert.equal(moment.utc("2012-12-31T00:00:00.000Z").isoWeekYear(year).isoWeekYear(),
                year,
                "setting iso-week-year to " + year);
            assert.equal(moment.utc("2012-12-31T00:00:00.000Z").weekYear(year).weekYear(),
                year,
                "setting week-year to " + year);
        }

        assert.equal(moment.utc("2004-W53-1", moment.ISO_8601, true).isoWeekYear(2013).format("GGGG-[W]WW-E"),
            "2013-W52-1",
            "2004-W53-1 to 2013");
        assert.equal(moment.utc("2004-W53-1", moment.ISO_8601, true).isoWeekYear(2020).format("GGGG-[W]WW-E"),
            "2020-W53-1",
            "2004-W53-1 to 2020");
        assert.equal(moment.utc("2005-W52-1", moment.ISO_8601, true).isoWeekYear(2004).format("GGGG-[W]WW-E"),
            "2004-W52-1",
            "2005-W52-1 to 2004");
        assert.equal(moment.utc("2013-W30-4", moment.ISO_8601, true).isoWeekYear(2015).format("GGGG-[W]WW-E"),
            "2015-W30-4",
            "2013-W30-4 to 2015");

        assert.equal(moment.utc("2005-w53-0", "gggg-[w]ww-e", true).weekYear(2013).format("gggg-[w]ww-e"),
            "2013-w52-0",
            "2005-w53-0 to 2013");
        assert.equal(moment.utc("2005-w53-0", "gggg-[w]ww-e", true).weekYear(2016).format("gggg-[w]ww-e"),
            "2016-w53-0",
            "2005-w53-0 to 2016");
        assert.equal(moment.utc("2004-w52-0", "gggg-[w]ww-e", true).weekYear(2005).format("gggg-[w]ww-e"),
            "2005-w52-0",
            "2004-w52-0 to 2005");
        assert.equal(moment.utc("2013-w30-4", "gggg-[w]ww-e", true).weekYear(2015).format("gggg-[w]ww-e"),
            "2015-w30-4",
            "2013-w30-4 to 2015");
    });