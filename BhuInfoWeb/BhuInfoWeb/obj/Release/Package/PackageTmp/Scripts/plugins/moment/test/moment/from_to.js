...
test("from",
    function(assert) {
        ...
        assert.equal(start.from(start.clone().subtract(5, "seconds")),
            "in a few seconds",
...
test("from with absolute duration",
    function(assert) {
        ...
        assert.equal(start.from(start.clone().subtract(5, "seconds"), true),
            "a few seconds",
...
test("to",
    function(assert) {
        var start = moment();
        moment.locale("en");
        assert.equal(start.to(start.clone().subtract(5, "seconds")),
            "a few seconds ago",
