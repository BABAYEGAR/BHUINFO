...
test("day of year setters",
    function(assert) {
        assert.equal(moment([2000, 0, 1]).dayOfYear(200).dayOfYear(),
            200,
            "Setting Jan  1 2000 day of the year to 200 should work");
        assert.equal(moment([2000, 1, 28]).dayOfYear(200).dayOfYear(),
            200,
            "Setting Feb 28 2000 day of the year to 200 should work");
        assert.equal(moment([2000, 1, 29]).dayOfYear(200).dayOfYear(),
            200,
            "Setting Feb 28 2000 day of the year to 200 should work");
        assert.equal(moment([2000, 11, 31]).dayOfYear(200).dayOfYear(),
            200,
...
test("iso weeks setter day of year",
    function(assert) {
        assert.equal(moment([2012, 0, 1]).isoWeek(1).dayOfYear(),
            9,
        ...
        assert.equal(moment([2012, 0, 2]).isoWeek(1).dayOfYear(),
            2,
            "Setting Jan  2 2012 to week 1 should be day of year 2");
        assert.equal(moment([2012, 0, 8]).isoWeek(1).dayOfYear(),
            8,
            "Setting Jan  8 2012 to week 1 should be day of year 8");
        assert.equal(moment([2012, 0, 9]).isoWeek(1).dayOfYear(),
            2,
            "Setting Jan  9 2012 to week 1 should be day of year 2");
        assert.equal(moment([2012, 0, 15]).isoWeek(1).dayOfYear(),
            8,
