...
test("instatiation from serialized C# TimeSpan zero",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan with days",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan without days",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan without days or milliseconds",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan without milliseconds",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan maxValue",
    function(assert) {
...
test("instatiation from serialized C# TimeSpan minValue",
    function(assert) {
...
test("instantiation from ISO 8601 duration",
    function(assert) {
        assert.equal(moment.duration("P1Y2M3DT4H5M6S").asSeconds(),
            moment.duration({ y: 1, M: 2, d: 3, h: 4, m: 5, s: 6 }).asSeconds(),
            "all fields");
        assert.equal(moment.duration("P3W3D").asSeconds(),
        ...
        assert.equal(moment.duration("P1MT2H").asSeconds(),
        ...
        assert.equal(moment.duration("PT0.5S").asSeconds(),
...
test("serialization to ISO 8601 duration strings",
    function(assert) {
        assert.equal(moment.duration({ y: 1, M: 2, d: 3, h: 4, m: 5, s: 6 }).toISOString(),
            "P1Y2M3DT4H5M6S",
            "all fields");
...
test("toIsoString deprecation",
    function(assert) {
        ...
        assert.equal(moment.duration({}).toIsoString(),
...
test("`isodate` (python) test cases",
    function(assert) {
        assert.equal(moment.duration("P18Y9M4DT11H9M8S").asSeconds(),
        ...
        assert.equal(moment.duration("P3Y6M4DT12H30M5S").asSeconds(),
            moment.duration({ y: 3, M: 6, d: 4, h: 12, m: 30, s: 5 }).asSeconds(),
            "python isodate 3");
        assert.equal(moment.duration("P23DT23H").asSeconds(),
        ...
        assert.equal(moment.duration("P1DT12H").asSeconds(),
        ...
        assert.equal(moment.duration("-P2.2W").asSeconds(),
            moment.duration({ w: -2.2 }).asSeconds(),
            "python isodate 12");
        assert.equal(moment.duration("P1DT2H3M4S").asSeconds(),
            moment.duration({ d: 1, h: 2, m: 3, s: 4 }).asSeconds(),
            "python isodate 13");
        assert.equal(moment.duration("P1DT2H3M").asSeconds(),
            moment.duration({ d: 1, h: 2, m: 3 }).asSeconds(),
            "python isodate 14");
        assert.equal(moment.duration("P1DT2H").asSeconds(),
        ...
        assert.equal(moment.duration("PT2.3H").asSeconds(),
            moment.duration({ h: 2.3 }).asSeconds(),
            "python isodate 17");
        assert.equal(moment.duration("PT2H3M4S").asSeconds(),
            moment.duration({ h: 2, m: 3, s: 4 }).asSeconds(),
            "python isodate 18");
        assert.equal(moment.duration("PT3M4S").asSeconds(),
        ...
        assert.equal(moment.duration("PT22.22S").asSeconds(),
        ...
        assert.equal(moment.duration("-P1DT2H3M4S").asSeconds(),
            moment.duration({ d: -1, h: -2, m: -3, s: -4 }).asSeconds(),
            "python isodate 24");
        assert.equal(moment.duration("PT-6H3M").asSeconds(),
            moment.duration({ h: -6, m: 3 }).asSeconds(),
            "python isodate 25");
        assert.equal(moment.duration("-PT-6H3M").asSeconds(),
            moment.duration({ h: 6, m: -3 }).asSeconds(),
            "python isodate 26");
        assert.equal(moment.duration("-P-3Y-6M-4DT-12H-30M-5S").asSeconds(),
            moment.duration({ y: 3, M: 6, d: 4, h: 12, m: 30, s: 5 }).asSeconds(),
            "python isodate 27");
        assert.equal(moment.duration("P-3Y-6M-4DT-12H-30M-5S").asSeconds(),
            moment.duration({ y: -3, M: -6, d: -4, h: -12, m: -30, s: -5 }).asSeconds(),
...
test("humanize duration with suffix",
    function(assert) {
        ...
        assert.equal(moment.duration({ seconds: -44 }).humanize(true),
            "a few seconds ago",
...
test("bubble value up",
    function(assert) {
        assert.equal(moment.duration({ milliseconds: 61001 }).milliseconds(),
            1,
            "61001 milliseconds has 1 millisecond left over");
        assert.equal(moment
            .duration({ milliseconds: 61001 })
            .seconds(),
            1,
...
test("asGetters",
    function(assert) {
        ...
        assert.equal(moment.duration(1, "millisecond").asMonths().toFixed(12),
            0.000000000380,
...
test("add",
    function(assert) {
        ...
        assert.equal(d.add({ h: 23, m: 59 })._milliseconds,
...
test("add and bubble",
    function(assert) {
        ...
        assert.equal(moment.duration(1, "second").add(1000, "milliseconds").seconds(),
            2,
            "Adding milliseconds should bubble up to seconds");
        assert.equal(moment.duration(1, "minute").add(60, "second").minutes(),
            2,
            "Adding seconds should bubble up to minutes");
        assert.equal(moment.duration(1, "hour").add(60, "minutes").hours(),
            2,
...
test("subtract and bubble",
    function(assert) {
        ...
        assert.equal(moment.duration(2, "second").subtract(1000, "milliseconds").seconds(),
            1,
            "Subtracting milliseconds should bubble up to seconds");
        assert.equal(moment.duration(2, "minute").subtract(60, "second").minutes(),
            1,
            "Subtracting seconds should bubble up to minutes");
        assert.equal(moment.duration(2, "hour").subtract(60, "minutes").hours(),
            1,
            "Subtracting minutes should bubble up to hours");
        assert.equal(moment.duration(2, "day").subtract(24, "hours").days(),
            1,
...
test("subtract",
    function(assert) {
        ...
        assert.equal(d.subtract({ h: 1, m: 59 })._milliseconds,
