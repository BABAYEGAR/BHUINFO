...
test("normalize units",
    function(assert) {
        var fullKeys = [
                "year", "quarter", "month", "isoWeek", "week", "day", "hour", "minute", "second", "millisecond", "date",
                "dayOfYear", "weekday", "isoWeekday", "weekYear", "isoWeekYear"
            ],
        ...
        for (index = 0; index < length; index += 1) {
            ...
            assert.equal(moment.normalizeUnits(fullKeyCapsPlural),
                fullKey,
